...
const getModelDefaults = (settings: BillingSettings) => ({
  ...
  InputMaterialPrices: settings.InputMaterialPrices,
  MaterialDefaultVideoSeconds: settings.MaterialDefaultVideoSeconds,
  MaterialDefaultAudioSeconds: settings.MaterialDefaultAudioSeconds,
